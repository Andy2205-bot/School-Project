                    ...
                    <div class="card-body">
                        ...
                        <table class="table datatable">
                            ...
                            <tbody>
                                ...
                                $pClass = new ProgramModulesClass($db);
                                $response = array();
                                $response = $pClass->GetProgramAndLevelByProgramModuleId($programId);

                                $stmt  = $students->GetAllStudentsByProgramIdAndLevelId($response['programId'],$response['levelId']);
